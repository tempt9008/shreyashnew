import { Routes, Route, Link } from 'react-router-dom';
    ...
    import AllQuestionsPDFDownloadButton from '../components/AllQuestionsPDFDownloadButton';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between h-16">
                ...
                <div className="flex items-center">
                  <AllQuestionsPDFDownloadButton />
                  <button
                    onClick={logout}
                    className="flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 hover:text-gray-700 focus:outline-none transition ml-4"
                  >
